...
function load() {
  ...
  if (localStorage['time']) {
    totalTimeWastedInminutos = parseFloat(localStorage['time']);
    convertminutos(parseFloat(localStorage['time']));
  }
...
(function ($, undefined) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "    <input type='text' autocomplete='off' autocorrect='off' placeholder='Digite uma série' title='Nome da série' autocapitalize='off' spellcheck='false' class='select2-input' required autofocus='true'>",
                "  </li>",
                "</ul>",
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Por favor, insira " + n + " caracteres" + (n == 1? "" : "s"); },
  ...
  if (selectedTVshow[0].seasons >= 0 && selectedTVshow[0].runtime >= 0) {
    ...
    if (typeof(selectedTVshow[0]) != "undefined") {
      ...
      // } else {
        ...
        $('.container__list-of-shows').prepend('<li class="show-to-add  visuallyhidden"><a href="#" class="btn icon-close  js-remove-item" title="Remover está série"></a><img src="' + poster + '" alt="' + selectedTVshow[0].text + '" /><div class="container__list-of-shows__info"><span class="container__list-of-shows__info__title" title="Título da série">' + selectedTVshow[0].text +'</span><span class="container__list-of-shows__info__seasons" title="Número da temporada"></span><span class="container__list-of-shows__info__wasted-time  visuallyhidden"></span></div></li>');
    ...
    var $listItem = $('.select2-results');
    $listItem.parent().css("display", "block");
    $('<li />').addClass('select2-no-results').html('Essa série não esta cadastrada no momento. Tente outra.').appendTo($listItem);
    hasSelectedShow = false;
...
function updateClock(dias, horas, minutos) {
  ...
  if (dias < 01) {
    $('.sharing-link').attr('href', 'https://twitter.com/share?text=I’ve wasted ' + horas + ' horas and ' + minutos + ' minutos of my life watching TV shows. Calculate your time:&url=http://kuldeepsinghsidhu.com/time');
  } else if (dias == 01) {
    $('.sharing-link').attr('href', 'https://twitter.com/share?text=I’ve wasted ' + dias + ' dia, ' + horas + ' horas, and ' + minutos + ' minutos of my life watching TV shows. Calculate your time:&url=http://kuldeepsinghsidhu.com/time');
  } else if (horas < 01) {
    $('.sharing-link').attr('href', 'https://twitter.com/share?text=I’ve wasted ' + dias + ' dias and ' + minutos + ' minutos of my life watching TV shows. Calculate your time:&url=http://kuldeepsinghsidhu.com/time');
  } else if (horas == 01) {
    $('.sharing-link').attr('href', 'https://twitter.com/share?text=I’ve wasted ' + dias + ' dias, ' + horas + ' hora, and ' + minutos + ' minutos of my life watching TV shows. Calculate your time:&url=http://kuldeepsinghsidhu.com/time');
  } else if (minutos < 01) {
    $('.sharing-link').attr('href', 'https://twitter.com/share?text=I’ve wasted ' + dias + ' dias and ' + horas + ' horas of my life watching TV shows. Calculate your time:&url=http://kuldeepsinghsidhu.com/time');
  } else if (minutos == 01) {
    $('.sharing-link').attr('href', 'https://twitter.com/share?text=I’ve wasted ' + dias + ' dias, ' + horas + ' horas, and ' + minutos + ' minute of my life watching TV shows. Calculate your time:&url=http://kuldeepsinghsidhu.com/time');
  } else if ((horas < 01) && (minutos < 01)) {
    $('.sharing-link').attr('href', 'https://twitter.com/share?text=I’ve wasted ' + dias + ' dias of my life watching TV shows. Calculate your time:&url=http://kuldeepsinghsidhu.com/time');
  } else {
    $('.sharing-link').attr('href', 'https://twitter.com/share?text=I’ve wasted ' + dias + ' dias, ' + horas + ' horas, and ' + minutos + ' minutos of my life watching TV shows. Calculate your time:&url=http://kuldeepsinghsidhu.com/time');
  }
}
...
$('.container__list-of-shows').on('click touchstart', '.js-remove-item', function() {
  ...
  timeWastedInminutos = $(this).siblings('.container__list-of-shows__info').children('.container__list-of-shows__info__wasted-time.visuallyhidden').text();

  // calculate total time wasted in minutos
  totalTimeWastedInminutos = totalTimeWastedInminutos - timeWastedInminutos;
  if (totalTimeWastedInminutos <= 0)
    totalTimeWastedInminutos = 0;
  ...
  showTemporaryTimerOfPreviousShow(timeWastedInminutos, true);
